...
<body style="height:100%; margin: 0px;">
    ...
    <img src="assets/green.jpg" style="height: 600px; padding: 20px;">
    </div>
    
    <div class="w3-card w3-round" style="display:inline-block; vertical-align: middle; padding: 10px; text-align:center">
    <h1 style="font-family:'TSHandwriting'">Register</h1>
    <form action ="register_process.php" method="POST" style=" font-family:'Courier New', Courier, monospace;">
        <label for="username">Username</label>
        <input type="text" id="username" name="username" style="padding:1%;">
        <br>
        <label for="pass">Password</label>
        <input type="password" id="pass" name="password" style="padding:1%;">
        <br>
